...
xst -ifn xst.scr
move clockdv4_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clockdv4_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockdv4_exdes.ucf clockdv4_exdes

echo 'Running map'
map -timing -pr b clockdv4_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clockdv4_exdes -w routed.ncd routed.vhd
cd ..
